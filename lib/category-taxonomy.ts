...
export const CATEGORY_TAXONOMY: CategoryNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      node("shopping.phone-accessories", "Cep Telefonu Aksesuarları", ["telefon aksesuar"], ["kılıf", "kilif", "şarj", "sarj", "powerbank", "ekran koruyucu", "kablo", "tutucu", "batarya", "lens", "selfie"], [], [
        node("accessories.cases", "Kılıf", ["kılıf", "kilif"], ["silikon kılıf", "deri kılıf", "kapak", "cover", "telefon kılıfı", "telefon kilifi"]),
        node("accessories.chargers", "Şarj Aleti", ["şarj aleti", "sarj aleti", "şarj cihazı", "sarj cihazi"], ["hızlı şarj", "hizli sarj", "şarj adaptörü", "sarj adaptoru", "duvar şarjı", "duvar sarji"]),
        node("accessories.cables", "Kablo", ["kablo", "data kablosu"], ["usb kablo", "type c", "lightning", "usb c", "şarj kablosu", "sarj kablosu"]),
        node("accessories.powerbanks", "Powerbank", ["powerbank", "power bank", "taşınabilir şarj", "tasınabilir sarj"], ["powerbank 10000", "powerbank 20000", "pil kutusu"]),
        node("accessories.screen-protectors", "Ekran Koruyucu", ["ekran koruyucu", "ekran koruma"], ["temperli cam", "jel film", "nano ekran", "ekran filmi"]),
        node("accessories.batteries", "Batarya / Yedek Pil", ["batarya", "yedek pil"], ["telefon bataryası", "telefon bataryasi", "orijinal batarya", "pil değişimi"]),
        node("accessories.holders", "Tutucu", ["tutucu", "telefon tutucu", "telefon aparatı", "telefon aparati"], ["araç tutucu", "arac tutucu", "masa tutucu", "magnet tutucu", "telefon standı", "telefon standi"]),
        node("accessories.adapters", "Adapter / Dönüştürücü", ["adapter", "dönüştürücü", "donusturucu", "çevirici", "cevirici"], ["usb adapter", "type c hub", "otg", "aux dönüştürücü", "aux donusturucu"]),
        node("accessories.lens-kits", "Lens", ["lens", "telefon lensi"], ["geniş açı lens", "genis aci lens", "makro lens", "tele lens"]),
        node("accessories.selfie", "Selfie Çubuğu", ["selfie çubuğu", "selfie cubugu", "monopod", "selfie stick"], ["bluetooth selfie", "selfie stick bluetooth"]),
      ]),
